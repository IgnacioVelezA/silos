...
if __name__ == '__main__':
    ...
    traj = [(0.0, 0.0), (-90.0, 4.28), (-90.0, 8.57), (90.0, 8.57), (-90.0, 12.85), (30.0, 12.85), (-30.0, -12.85), (-90.0, 17.14), (0.0, 17.14), (90.0, 17.14), (0.0, -17.14), (-90.0, 21.42), (-18.0, 21.42), (54.0, 21.42), (-54.0, -21.42), (18.0, -21.42), (-90.0, 25.71), (-30.0, 25.71), (30.0, 25.71), (90.0, 25.71), (-30.0, -25.71), (30.0, -25.71), (-90.0, 30.0), (-38.57, 30.0), (12.85, 30.0), (64.28, 30.0), (-64.28, -30.0), (-12.85, -30.0), (38.57, -30.0)]
#[(90, 27), (84, 26), (78, 25), (72, 24), (65, 23), (58, 23), (50, 23), (44, 24), (37, 25), (30, 27), (24, 26), (18, 25), (12, 24), (5, 23), (-2, 23), (-10, 23), (-16, 24), (-23, 25), (-30, 27), (-36, 26), (-42, 25), (-48, 24), (-55, 23), (-62, 23), (-70, 23), (-76, 24), (-83, 25), (-90, 27), (84, -26), (78, -25), (72, -24), (65, -23), (58, -23), (50, -23), (44, -24), (37, -25), (30, -27), (24, -26), (18, -25), (12, -24), (5, -23), (-2, -23), (-10, -23), (-16, -24), (-23, -25), (-30, -27), (-36, -26), (-42, -25), (-48, -24), (-55, -23), (-62, -23), (-70, -23), (-76, -24)] #hex_trajectory.hex_trajectory(RADIO_BEAM, RADIO_SURFACE, set_offset_el=True, offset_elev_degree = 5.0)
